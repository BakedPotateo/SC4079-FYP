...
// // ExportableChar represents the exportable version with capitalized fields
// type ExportableChar struct {
// 	Name string `json:"name"`
// 	// Palfx                 *PalFX                        `json:"palfx"`
// 	// Anim                  *Animation                    `json:"anim"`
// 	// CurFrame              *AnimFrame                    `json:"cur_frame"`
// 	// Cmd                   []CommandList                 `json:"cmd"`
// 	// Ss                    StateState                    `json:"ss"`
// 	Key int   `json:"key"`
// 	Id  int32 `json:"id"`
// 	// HelperId              int32                         `json:"helper_id"`
// 	// HelperIndex           int32                         `json:"helper_index"`
// 	// ParentIndex           int32                         `json:"parent_index"`
// 	// PlayerNo              int                           `json:"player_no"`
// 	// Teamside              int                           `json:"teamside"`
// 	// Keyctrl               [4]bool                       `json:"keyctrl"`
// 	// Player                bool                          `json:"player"`
// 	AnimPN          int                           `json:"anim_pn"`
// 	AnimNo          int32                         `json:"anim_no"`
// 	PrevAnimNo      int32                         `json:"prev_anim_no"`
...
// 	FallTime        int32                         `json:"fall_time"`
// 	Localcoord      float32                       `json:"localcoord"`
// 	Localscl        float32                       `json:"localscl"`
// 	Size            CharSize                      `json:"size"`
// 	ClsnScale       [2]float32                    `json:"clsn_scale"`
// 	Hitdef          HitDef                        `json:"hitdef"`
// 	Ghv             GetHitVar                     `json:"ghv"`
// 	Hitby           [2]HitBy                      `json:"hitby"`
// 	Ho              [8]HitOverride                `json:"ho"`
// 	HoIdx           int                           `json:"ho_idx"`
// 	Mctype          MoveContact                   `json:"mctype"`
// 	Mctime          int32                         `json:"mctime"`
// 	Children        []*ExportableChar             `json:"children"`
// 	Targets         []int32                       `json:"targets"`
// 	TargetsOfHitdef []int32                       `json:"targets_of_hitdef"`
// 	Enemynear       [2][]*ExportableChar          `json:"enemynear"`
// 	P2enemy         []*ExportableChar             `json:"p2enemy"`
// 	Pos             [3]float32                    `json:"pos"`
// 	DrawPos         [3]float32                    `json:"draw_pos"`
// 	OldPos          [3]float32                    `json:"old_pos"`
// 	Vel             [3]float32                    `json:"vel"`
// 	Facing          float32                       `json:"facing"`
// 	Ivar            [NumVar + NumSysVar]int32     `json:"ivar"`
// 	Fvar            [NumFvar + NumSysFvar]float32 `json:"fvar"`
// 	// CharSystemVar         `json:"char_system_var"`
// 	Aimg AfterImage `json:"aimg"`
// 	// SoundChannels         SoundChannels          `json:"sound_channels"`
// 	P1facing      float32    `json:"p1facing"`
// 	Cpucmd        int32      `json:"cpucmd"`
// 	AttackDist    float32    `json:"attack_dist"`
// 	Offset        [2]float32 `json:"offset"`
// 	Stchtmp       bool       `json:"stchtmp"`
// 	Inguarddist   bool       `json:"inguarddist"`
// 	Pushed        bool       `json:"pushed"`
// 	HitdefContact bool       `json:"hitdef_contact"`
// 	Atktmp        int8       `json:"atktmp"`
// 	Hittmp        int8       `json:"hittmp"`
// 	Acttmp        int8       `json:"acttmp"`
// 	Minus         int8       `json:"minus"`
// 	PlatformPosY  float32    `json:"platform_pos_y"`
// 	GroundAngle   float32    `json:"ground_angle"`
// 	Ownpal        bool       `json:"ownpal"`
// 	// Winquote              int32                  `json:"winquote"`
// 	MemberNo              int   `json:"member_no"`
// 	SelectNo              int   `json:"select_no"`
// 	ComboExtraFrameWindow int32 `json:"combo_extra_frame_window"`
// 	InheritJuggle         int32 `json:"inherit_juggle"`
// 	InheritChannels       int32 `json:"inherit_channels"`
// 	// MapArray              map[string]float32     `json:"map_array"`
// 	// MapDefault            map[string]float32     `json:"map_default"`
// 	// RemapSpr              RemapPreset            `json:"remap_spr"`
// 	// ClipboardText         []string               `json:"clipboard_text"`
// 	// Dialogue              []string               `json:"dialogue"`
// 	Immortal   bool  `json:"immortal"`
// 	Kovelocity bool  `json:"kovelocity"`
// 	Preserve   int32 `json:"preserve"`
// 	// DefaultHitScale       [3]*HitScale           `json:"default_hit_scale"`
// 	// NextHitScale          map[int32][3]*HitScale `json:"next_hit_scale"`
// 	// ActiveHitScale        map[int32][3]*HitScale `json:"active_hit_scale"`
// 	// InputFlag             InputBits              `json:"input_flag"`
// 	// PauseBool             bool                   `json:"pause_bool"`
// 	DownHitOffset float32 `json:"down_hit_offset"`
// 	KoEchoTime    int32   `json:"ko_echo_time"`
// }

// ToExportable converts a Char instance into ExportableChar
// func (c *Char) ToExportable() ExportableChar {
// 	exportable := ExportableChar{
// 		// Name:                  c.name,
// 		// Palfx:                 c.palfx,
// 		// Anim:                  c.anim,
// 		// CurFrame:              c.curFrame,
...
// 		InheritChannels:       c.inheritChannels,
// 		// MapArray:              c.mapArray,
...
// 		DownHitOffset: c.downHitOffset,
// 		KoEchoTime:    c.koEchoTime,
// 	}
// 	return exportable
// }

// // ToJSON is a method that marshals the Char struct to JSON
// func (c *Char) ToJSON() ([]byte, error) {
// 	cExp := c.ToExportable()
// 	return json.Marshal(cExp)
// }
